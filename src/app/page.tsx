  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center">
      ...
      <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
        Discover, register, and manage your decentralized services with ease. The PANDA Ecosystem provides a suite of tools for a connected digital world.
      </p>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <Button asChild className="w-full">
              <Link href="/auth/register">Register Now <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <Button variant="outline" asChild className="w-full">
              <Link href="/auth/login">Login <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </CardContent>
        </Card>
      </div>
      ...
      <p className="text-sm text-muted-foreground mt-8">
        PANDA Ecosystem: Secure. Decentralized. Connected.
      </p>
    </div>
  );
}
